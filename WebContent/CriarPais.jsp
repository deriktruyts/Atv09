			...
			<form action="controller.do" method="post">
				...
				<div class="row">
					<div class="form-group col-md-6">
						...
						<input type="text" name="populacao" class="form-control" id="populacao" required maxlength="100" placeholder="População do país">
					</div>
					
					<div class="form-group col-md-6">
						<label for="nome">ÁREA:</label> 
						<input type="text" name="area" class="form-control" id="area" required maxlength="100" placeholder="Área do país">
					</div>
				</div>
				<hr/>
